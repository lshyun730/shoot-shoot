...
function imagesList(){
    ...
    this.enemyblack.src = "./../img/enemyblack.png";
    ...
    this.enemyred.src = "./../img/enemyred.png";
    ...
    this.enemywhite.src = "./../img/enemywhite.png";
    ...
    this.explosion.src = "./../img/explode.png";
